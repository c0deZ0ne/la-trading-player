...
public class GarlicLauncher implements LauncherInterface
{
    ...
    final String PROVIDER_NAME = "com.laplayer.launcher.SettingsProvider";
    ...
    {
        Intent intent = new Intent("com.laplayer.launcher.receiver.CommandReceiver");
    ...
    {
        Intent intent = new Intent("com.laplayer.launcher.receiver.InstallAppReceiver");
