...
import com.laplayer.player.java.SICPDef.SICPCommand;
import com.laplayer.player.java.SocketClient.SocketResponse;
...
//        intent.addFlags(Intent.FLAG_RECEIVER_INCLUDE_BACKGROUND);
    ...
    public void installSoftware(String apk_path)
    {
        ...
        intent.putExtra("packageName", "com.laplayer.player");
        intent.putExtra("activityName", "com.laplayer.player.java.GarlicActivity");
